...
export const employeesHR: EmployeeHR[] = [
  { id: "u1", name: "سارة أحمد", department: "الهندسة", role: "مهندسة برمجيات", joinDate: "2021-03-14", status: "watch", avgMood: 3.8, absenceDays: 2, email: "sara@nabd.io" },
  { id: "u2", name: "أحمد خالد", department: "المبيعات", role: "مدير مبيعات", joinDate: "2020-07-01", status: "stable", avgMood: 4.2, absenceDays: 1, email: "ahmad@nabd.io" },
  ...
  { id: "u4", name: "خالد عمر", department: "الهندسة", role: "مطور أول", joinDate: "2019-11-20", status: "stable", avgMood: 4.4, absenceDays: 0, email: "khaled@nabd.io" },
  ...
  { id: "u6", name: "عمر يوسف", department: "التسويق", role: "مصمم جرافيك", joinDate: "2023-02-14", status: "watch", avgMood: 3.5, absenceDays: 3, email: "omar@nabd.io" },
];
