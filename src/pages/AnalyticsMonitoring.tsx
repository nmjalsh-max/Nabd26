...
export default function AnalyticsMonitoring() {
  ...
  return (
    <PageShell>
      <PageHeader title="Analytics & Monitoring" description="Live charts and automatic classification from the last 5 responses." />

      <DataState variant={variant} loading={<div style={{ color: C.textLo, fontSize: 12 }}>Preparing charts…</div>}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <SectionCard title="Automatic Classification">
