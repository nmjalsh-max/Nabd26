...
export default function AnalyticsMonitoring2() {
  ...
  return (
    <PageShell>
      <PageHeader
        title="Analytics & Monitoring — Standalone View"
        description="Additional mock view to match the independent design section when needed."
        actions={
          <StatCard
            label="Overall indicator"
      ...
      <DataState variant={variant} loading={<div style={{ color: C.textLo, fontSize: 12 }}>Preparing summary…</div>}>
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <SectionCard title="Status Summary" description="Example of a standalone page showing mock-ready indicators.">
          ...
          <SectionCard title="Quick Details" description="Small table view — without charting libraries.">
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 520 }}>
                <thead>
                  <tr>
                    {["Employee", "Department", "Average", "Status"].map((h) => (
                      <th
                        key={h}
                        style={{
                          textAlign: "right",
